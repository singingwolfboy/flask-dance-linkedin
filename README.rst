Flask-Dance Example App: LinkedIn Edition
=========================================

This repository provides an example of how to use `Flask-Dance`_ to connect
to `LinkedIn`_ as an OAuth client. The example code is in ``linkedin.py`` --
...
you'll end up at a LinkedIn 404 page. That's OK, we're not done yet!

Step 2: Get OAuth credentials from LinkedIn
-------------------------------------------
TBD
...
are available, and then the "Edit" button to allow you to
change these variables.

Take the client ID you got from LinkedIn, and paste it into the "VALUE" field
next to the ``LINKEDIN_OAUTH_CLIENT_ID`` field, replacing the dummy value that
was there before. Similarly, take the client secret you got from LinkedIn,
and paste it into the "VALUE" field next to the
``LINKEDIN_OAUTH_CLIENT_SECRET`` field,
replacing the dummy value that was there before.
Click the "Save" button when you're done.

Step 4: Visit your app and login with LinkedIn!
-----------------------------------------------
...
immediately be redirected to login with LinkedIn!

Local Installation
``````````````````
If you'd prefer to run this locally on your computer, you can do that as well.

Step 1: Get OAuth credentials from LinkedIn
-------------------------------------------
TBD
...
Run the following commands on your computer::
    ...
    git clone https://github.com/singingwolfboy/flask-dance-linkedin.git
...
* ``LINKEDIN_OAUTH_CLIENT_ID``: set this to the client ID you got
  from LinkedIn.
* ``LINKEDIN_OAUTH_CLIENT_SECRET``: set this to the client secret you got
  from LinkedIn.
...
For Windows, you can use the `SET`_ command. If
...
Step 4: Run your app and login with LinkedIn!
---------------------------------------------
If you're setting environment variables manually, run your app using Python::

    FLASK_APP=linkedin.py flask run
...
Then, go to http://localhost:5000/ to visit your app and log in with LinkedIn!
